class Menu extends Phaser.Scene {
    ...
    create() {
        ...
        this.nameText = this.add.text(game.config.width-700,game.config.height/2-200, 'Mixing Mayhem', textConfig).setOrigin(0);
